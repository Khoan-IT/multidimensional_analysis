...
| 2370069 	| Ngo Minh Hong Thai     	| Computer Science  |
| 2370041 	| Huy        	| Computer Science  |
...
```{r, tidy=FALSE, fig.align='center', fig.width=5, fig.height=5, fig.cap=cap[2:14]}
for (col in colnames(data)){
  if (col != 'diagnosis'){
...
```{r, tidy=FALSE, fig.align='center', fig.width=5, fig.height=5, fig.cap=cap[1:14]}
for (col in colnames(data)){
  if(col != 'diagnosis'){
